...
plantaoInvalido5 = [(6,[Medicar m2])
           ,(8,[Medicar m2, Medicar m1])
           ,(17,[Medicar m1])
           ,(22,[Medicar m3])]
...
casoTesteTomar = tomarMedicamento m6 estoque1 == Nothing
conjuntoCasosTeste2 = and [casoTeste5,casoTeste6, casoTesteTomar]

--testando consultarMedicamento
casoTeste7 = consultarMedicamento m2 estoque1 == 5
casoTeste8 = consultarMedicamento "Aas" estoque1 == 0
conjuntoCasosTeste3 = and [casoTeste7,casoTeste8]

-- testando demandaMedicamentos
casoTeste9 = demandaMedicamentos receituario1 == [(m1,2),(m2,1),(m3,1)]
casoTesteReceituario2 = demandaMedicamentos receituario2 == [(m1, 2), (m2, 1), (m3, 1), (m4, 3)]
conjuntoCasosTeste4 = and [casoTeste9, casoTesteReceituario2]

-- testando receituarioValido
casoTesteReceituarioValido1 = receituarioValido [] == True
casoTesteReceituarioValido2 = receituarioValido [(m1, [10])] == True
casoTesteReceituarioValido3 = receituarioValido [(m1, [10]), (m2, [8])] == True
casoTesteReceituarioValido4 = receituarioValido [(m1, [8,20]), (m2, [8])] == True
casoTesteReceituarioValido5 = receituarioValido receituario1 == True
casoTesteReceituarioValido6 = receituarioValido [(m1, [10]), (m1, [8])] == False
casoTesteReceituarioValido7 = receituarioValido [(m1, [10]), (m2, [8, 8])] == False
casoTesteReceituarioValido8 = receituarioValido [(m3,[2]), (m1, [4])] == False
casoTesteReceituarioValido9 = receituarioValido [(m1,[2]), (m2, [4,1])] == False
conjuntoCasoTesteReceituarioValido = and [casoTesteReceituarioValido1, casoTesteReceituarioValido2, casoTesteReceituarioValido3, casoTesteReceituarioValido4, casoTesteReceituarioValido5, casoTesteReceituarioValido6, casoTesteReceituarioValido7, casoTesteReceituarioValido8, casoTesteReceituarioValido9]

-- testando planoValido
casoTestePlanoValido1 = planoValido [] == True
casoTestePlanoValido2 = planoValido [(8, [m1])] == True
casoTestePlanoValido3 = planoValido [(8, [m1]), (10, [m1])] == True
casoTestePlanoValido4 = planoValido [(8, [m1, m2]), (10, [m1])] == True
casoTestePlanoValido5 = planoValido [(10, [m1]), (8, [m1])] == False
casoTestePlanoValido6 = planoValido [(10, [m1, m3]), (20, [m3, m1])] == False
casoTestePlanoValido7 = planoValido [(10, [m1, m3]), (20, [m3, m3])] == False
casoTestePlanoValido8 = planoValido [(10, [m1, m3]), (10, [m3])] == False
conjuntoCasoTestePlanoValido = and [casoTestePlanoValido1, casoTestePlanoValido2, casoTestePlanoValido3, casoTestePlanoValido4, casoTestePlanoValido5, casoTestePlanoValido6, casoTestePlanoValido7, casoTestePlanoValido8]
...
conjuntoCasosTestePlantaoValido =
  and [ plantaoValido plantao1 == True
      ...
      plantaoValido plantaoInvalido5 == False
      ]
